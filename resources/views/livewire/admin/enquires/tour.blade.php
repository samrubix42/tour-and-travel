            ...
            <table class="table card-table table-vcenter">
                ...
                <tbody>
                    @forelse($contacts as $c)
                        <tr>
                            <td>{{ $c->name }}</td>
                            <td>{{ optional($c->destination)->name ?? ($c->destination_name ?? '-') }}</td>
                            <td>{{ $c->email ?? '-' }}</td>
                            <td>{{ $c->phone ?? '-' }}</td>
                            <td class="text-muted">{{ $c->no_of_persons ?? '-' }}</td>
                            <td class="text-muted">{{ $c->travel_date ?? '-' }}</td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <dl class="row">
                            ...
                            <dd class="col-sm-9">{{ $selectedContact->destination_name ?? ($selectedContact->destination->name ?? '-') }}</dd>
                            ...
                            <dd class="col-sm-9">{{ $selectedContact->travel_date ?? '-' }}</dd>
