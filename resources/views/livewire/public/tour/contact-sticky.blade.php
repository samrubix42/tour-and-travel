<div>
    <style>
        ...
        /* custom checkbox */
        .custom-checkbox { display:flex; align-items:flex-start; gap:10px; }
        .custom-checkbox input[type="checkbox"]{ display:none; }
        .custom-checkbox .check { width:22px; height:22px; border-radius:50%; border:2px solid rgba(0,0,0,0.06); display:inline-flex; align-items:center; justify-content:center; background:#fff; transition:all .18s cubic-bezier(.2,.9,.2,1); box-shadow:0 6px 18px rgba(0,0,0,0.04); }
        .custom-checkbox .check svg{ width:14px; height:14px; fill:none; stroke:#fff; stroke-width:2.2px; opacity:0; transform:scale(0.8); transition:opacity .16s, transform .16s; }
        .custom-checkbox input[type="checkbox"]:checked + .check{ background:var(--accent); border-color:var(--accent); box-shadow:0 10px 30px rgba(228,91,21,0.18); transform:translateY(-1px) scale(1.02); }
        .custom-checkbox input[type="checkbox"]:checked + .check svg{ opacity:1; transform:scale(1); }
        .custom-checkbox .text { font-size:13px; color:#333; line-height:1.25; }
        .custom-checkbox .text { font-size:13px; color:#333; }
    </style>
                            ...
                            <div class="mb-3">
                                <label class="custom-checkbox" for="consentCheck">
                                    ...
                                    <span class="check" aria-hidden>
                                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><polyline points="20 6 9 17 4 12" style="fill:none;stroke:#fff;stroke-width:2.4;stroke-linecap:round;stroke-linejoin:round"/></svg>
                                    </span>
