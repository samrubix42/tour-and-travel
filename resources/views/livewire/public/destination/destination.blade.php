                    ...
                    <div class="col text-center interactive-banner-style-01 last-paragraph-no-margin mb-30px">
                            ...
                            <figcaption class="w-100 h-100 d-flex flex-column justify-content-end align-items-center p-30px">
                                <div class="position-relative z-index-1">
                                    <a href="{{ url('/destination/' . ($destination->slug ?? $destination->id)) }}" class="d-flex justify-content-center align-items-center mx-auto icon-box w-70px h-70px rounded-circle bg-white mb-50px box-shadow-quadruple-large"><i class="bi bi-arrow-right-short text-dark-gray icon-medium lh-0px"></i></a>
                                    <a href="{{ url('/destination/' . ($destination->slug ?? $destination->id)) }}" class="alt-font fs-22 fw-500 lette text-white d-inline-block text-uppercase">{{ $destination->name }}</a>
                                </div>
