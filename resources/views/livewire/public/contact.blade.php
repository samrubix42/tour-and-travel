            ...
            <div class="row align-items-center mt-2">
                <div class="col-lg-3 d-md-flex d-lg-inline-block md-mb-50px" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    <div class="mb-60px w-100 md-w-30 sm-w-50 xs-w-100 md-mb-30px sm-mb-40px float-start text-center text-sm-start">
                        ...
                        <a href="tel:1800222000" class="btn btn-link-gradient expand btn-extra-large text-base-color text-base-color-hover ls-0px">Call us today<span class="bg-base-color"></span></a>
                    </div>
                    <div class="mb-60px w-100 md-w-40 sm-w-50 xs-w-100 md-mb-30px sm-mb-40px float-start text-center text-sm-start">
                        <span class="d-block alt-font fs-22 fw-500 text-dark-gray ls-minus-05px mb-5px">Keep in touch</span>
                        <p class="w-100 mb-10px mx-auto mx-sm-0">401 Broadway, 24th Floor,<br>Orchard View, London</p>
                        <a href="https://maps.google.com/maps?ll=-37.805688,144.962312&amp;z=17&amp;t=m&amp;hl=en-US&amp;gl=IN&amp;mapclient=embed&amp;cid=13153204942596594449" target="_blank" class="btn btn-link-gradient expand btn-extra-large text-base-color text-base-color-hover ls-0px">Location map<span class="bg-base-color"></span></a>
                    </div>
                    <div class="md-w-30 w-100 sm-w-100 sm-clear-both text-center text-sm-start float-start">
                        ...
                        <div class="mb-10px"><a href="mailto:hr@yourdomain.com">hr@yourdomain.com</a></div>
                        <a href="mailto:info@yourdomain.com" class="btn btn-link-gradient expand btn-extra-large text-base-color text-base-color-hover ls-0px">Support desk<span class="bg-base-color"></span></a>
                    </div>
                </div>
                <div class="col-lg-9" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 1200, "delay": 100, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    <div class="row row-cols-1 row-cols-md-2 border-radius-6px overflow-hidden box-shadow-double-large m-0">
                        <div class="col cover-background sm-h-550px xs-h-450px" style="background-image: url('https://placehold.co/410x745')"></div>
                        <div class="col contact-form-style-03 bg-white p-70px lg-p-35px">
                            ...
                            <form action="email-templates/contact-form.php" method="post">
                                ...
                                <div class="position-relative form-group form-textarea mt-15px mb-10px xs-mb-0">
                                    ...
                                    <p class="fs-14 lh-22 mt-20px mb-0">We are committed to protecting your privacy. We will never collect information about you.</p>
                                </div>
                            </form>
                        </div>
                    </div>
