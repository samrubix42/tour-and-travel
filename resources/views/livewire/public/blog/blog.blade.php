                            ...
                            <div class="box-hover text-center">
                                <figure class="mb-0 position-relative">
                                    ...
                                    <figcaption class="post-content-wrapper overflow-hidden border-radius-6px">
                                        ...
                                        <div class="fs-15 bg-white p-15px lg-ps-10px lg-pe-10px lh-initial"><span class="d-inline-block">By <a href="demo-travel-agency-blog.html">Jonse robbert</a></span><span class="separator d-inline-block">|</span><a href="#">30 Nov 2023</a></div>
                                    </figcaption>
                                </figure>
                            </div>
                        </li>
                            ...
                            <div class="box-hover text-center">
                                <figure class="mb-0 position-relative">
                                    ...
                                    <figcaption class="post-content-wrapper overflow-hidden border-radius-6px">
                                        ...
                                        <div class="fs-15 bg-white p-15px lg-ps-10px lg-pe-10px lh-initial"><span class="d-inline-block">By <a href="demo-travel-agency-blog.html">Andy glamere</a></span><span class="separator d-inline-block">|</span><a href="#">28 Nov 2023</a></div>
                                    </figcaption>
                                </figure>
                            </div>
                        </li>
                        ...
                        <li class="grid-item mb-40px sm-mb-20px">
                            <div class="box-hover text-center">
                                <figure class="mb-0 position-relative">
                                    ...
                                    <figcaption class="post-content-wrapper overflow-hidden border-radius-6px">
                                        <div class="position-relative bg-dark-gray post-content p-30px z-index-2 lh-initial">
                                            <a href="demo-travel-agency-blog-single-modern.html" class="card-title mb-0 fs-20 lh-28 text-white d-inline-block">Build up healthy habits and strong peaceful life</a>
                                            <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                        </div>
                                        <div class="fs-15 bg-white p-15px lg-ps-10px lg-pe-10px lh-initial"><span class="d-inline-block">By <a href="demo-travel-agency-blog.html">Jonse robbert</a></span><span class="separator d-inline-block">|</span><a href="#">22 Nov 2023</a></div>
                                    </figcaption>
                                </figure>
                            </div>
                        </li>
                        ...
                        <li class="grid-item mb-40px sm-mb-20px">
                            <div class="box-hover text-center">
                                <figure class="mb-0 position-relative">
                                    ...
                                    <figcaption class="post-content-wrapper overflow-hidden border-radius-6px">
                                        <div class="position-relative bg-dark-gray post-content p-30px z-index-2 lh-initial">
                                            <a href="demo-travel-agency-blog-single-modern.html" class="card-title mb-0 fs-20 lh-28 text-white d-inline-block">Some people just try to celebrate the joys of life</a>
                                            <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                        </div>
                                        <div class="fs-15 bg-white p-15px lg-ps-10px lg-pe-10px lh-initial"><span class="d-inline-block">By <a href="demo-travel-agency-blog.html">Rosald smith</a></span><span class="separator d-inline-block">|</span><a href="#">20 Nov 2023</a></div>
                                    </figcaption>
                                </figure>
                            </div>
                        </li>
                        ...
                        <li class="grid-item mb-40px sm-mb-20px">
                            <div class="box-hover text-center">
                                <figure class="mb-0 position-relative">
                                    ...
                                    <figcaption class="post-content-wrapper overflow-hidden border-radius-6px">
                                        <div class="position-relative bg-dark-gray post-content p-30px z-index-2 lh-initial">
                                            <a href="demo-travel-agency-blog-single-modern.html" class="card-title mb-0 fs-20 lh-28 text-white d-inline-block">Many focus on embracing what they can control</a>
                                            <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                        </div>
                        ...
                        <li class="grid-item mb-40px sm-mb-20px">
                            <div class="box-hover text-center">
                                <figure class="mb-0 position-relative">
                                    ...
                                    <figcaption class="post-content-wrapper overflow-hidden border-radius-6px">
                                        <div class="position-relative bg-dark-gray post-content p-30px z-index-2 lh-initial">
                                            <a href="demo-travel-agency-blog-single-modern.html" class="card-title mb-0 fs-20 lh-28 text-white d-inline-block">No matter what you're feeling or experiencing</a>
                                            <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                        </div>
                                        <div class="fs-15 bg-white p-15px lg-ps-10px lg-pe-10px lh-initial"><span class="d-inline-block">By <a href="demo-travel-agency-blog.html">Den viliamson</a></span><span class="separator d-inline-block">|</span><a href="#">14 Nov 2023</a></div>
                                    </figcaption>
                                </figure>
                            </div>
                        </li>
                        ...
                        <li class="grid-item mb-40px sm-mb-20px">
                            <div class="box-hover text-center">
                                <figure class="mb-0 position-relative">
                                    ...
                                    <figcaption class="post-content-wrapper overflow-hidden border-radius-6px">
                                        <div class="position-relative bg-dark-gray post-content p-30px z-index-2 lh-initial">
                                            <a href="demo-travel-agency-blog-single-modern.html" class="card-title mb-0 fs-20 lh-28 text-white d-inline-block">The pessimist sees difficulty in opportunity</a>
                                            <div class="box-overlay bg-dark-gray z-index-minus-1"></div>
                                        </div>
                                        <div class="fs-15 bg-white p-15px lg-ps-10px lg-pe-10px lh-initial"><span class="d-inline-block">By <a href="demo-travel-agency-blog.html">Jonse robbert</a></span><span class="separator d-inline-block">|</span><a href="#">12 Nov 2023</a></div>
                                    </figcaption>
                                </figure>
                            </div>
                        </li>
                            ...
                            <div class="box-hover text-center">
                                <figure class="mb-0 position-relative">
                                    ...
                                    <figcaption class="post-content-wrapper overflow-hidden border-radius-6px">
                                        ...
                                        <div class="fs-15 bg-white p-15px lg-ps-10px lg-pe-10px lh-initial"><span class="d-inline-block">By <a href="demo-travel-agency-blog.html">Andy glamere</a></span><span class="separator d-inline-block">|</span><a href="#">10 Nov 2023</a></div>
                                    </figcaption>
                                </figure>
                            </div>
                        </li>
